...
const Input = forwardRef<
  HTMLInputElement,
  { idProp?: string; valueProp?: Date; nameProp?: string; placeholderProp?: string; dateFormat?: Intl.DateTimeFormatOptions }
>((props, ref) => {
  ...
  return (
    <input
      ...
      id={idProp}
      className={twMerge(
        "pl-9 pr-2 py-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500",
        options?.theme?.input
      )}
...
export const CalendarIcon = () => {
  ...
  return (
    <svg
      aria-hidden="true"
      className={twMerge("w-5 h-5 text-gray-500 dark:text-gray-400", options?.theme?.inputIcon)}
      fill="currentColor"
      viewBox="0 0 20 20"
