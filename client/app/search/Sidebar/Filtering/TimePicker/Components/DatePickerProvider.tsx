...
const DatePickerProvider = ({ children, options: customOptions, onChange, show, setShow, handleClear }: IDatePickerProviderProps) => {
  ...
  const getFormattedDate = (date: Date | number, formatOptions?: Intl.DateTimeFormatOptions | undefined | null) =>
